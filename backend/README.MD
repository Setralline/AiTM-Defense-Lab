...
> **Look at your terminal output!** The system generates a unique 16-character secure password every time the database is re-initialized. This ensures maximum security for the lab environment.
