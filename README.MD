...
2. **Run Schema:** Execute the SQL commands found in the **Database Setup** section of the [Backend README](https://www.google.com/search?q=./backend/README.md) to create the `users` table.
...
3. Configure your environment: Create a `.env` file with your database credentials (check [Backend README](https://www.google.com/search?q=./backend/README.md) for the template).
